...
function setOptions(opts) {
  ...
  if (opts.signer) {
    ...
    if (opts.signer.dilithium2PublicKey) {
      ...
      var rawKey = _strkey.StrKey.decodeDilithium2PublicKey(opts.signer.dilithium2PublicKey);
    ...
    if (opts.signer.dilithium2SignedPayload) {
      ...
      var _rawKey = _strkey.StrKey.decodeSignedPayload(opts.signer.dilithium2SignedPayload);
      var signedPayloadXdr = _xdr["default"].SignerKeyDilithium2SignedPayload.fromXDR(_rawKey);
