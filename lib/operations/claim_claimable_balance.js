...
function cov_i4fl18ix8() {
  var path = "/mnt/g/stellar-base/src/operations/claim_claimable_balance.js";
  var hash = "a6ba70893765057a2027b508f72b5835cd3a3fb7";
  var global = new Function("return this")();
  var gcv = "__coverage__";
  var coverageData = {
    path: "/mnt/g/stellar-base/src/operations/claim_claimable_balance.js",
    statementMap: {
      "0": {
        start: {
          line: 19,
    ...
    hash: "a6ba70893765057a2027b508f72b5835cd3a3fb7"
  };
...
function claimClaimableBalance() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (cov_i4fl18ix8().b[0][0]++, {});
  cov_i4fl18ix8().f[0]++;
  cov_i4fl18ix8().s[0]++;
  validateClaimableBalanceId(opts.balanceId);
  var attributes = (cov_i4fl18ix8().s[1]++, {});
  cov_i4fl18ix8().s[2]++;
  attributes.balanceId = _xdr["default"].ClaimableBalanceId.fromXDR(opts.balanceId, 'hex');
  var claimClaimableBalanceOp = (cov_i4fl18ix8().s[3]++, new _xdr["default"].ClaimClaimableBalanceOp(attributes));
  var opAttributes = (cov_i4fl18ix8().s[4]++, {});
  cov_i4fl18ix8().s[5]++;
...
function validateClaimableBalanceId(balanceId) {
  cov_i4fl18ix8().f[1]++;
  cov_i4fl18ix8().s[8]++;
  if ((cov_i4fl18ix8().b[2][0]++, typeof balanceId !== 'string') || (cov_i4fl18ix8().b[2][1]++, balanceId.length !== 8 + 64) /* 8b discriminant + 64b string */) {
    cov_i4fl18ix8().b[1][0]++;
    cov_i4fl18ix8().s[9]++;
